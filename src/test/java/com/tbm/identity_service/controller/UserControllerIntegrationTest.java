...
public class UserControllerIntegrationTest {
    ...
    void createUser_validRequest_succes() throws Exception {
        ...
        var response = mockMvc.perform(MockMvcRequestBuilders.post("/users")
                ...
                .andExpect(MockMvcResultMatchers.jsonPath("result.username").value("test01"))
                .andExpect(MockMvcResultMatchers.jsonPath("result.firstname").value("Thu"))
                .andExpect(MockMvcResultMatchers.jsonPath("result.lastname").value("Kiem"));
